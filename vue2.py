...
class Vue(object):
    ...
    def initJeu(self):
        ...
        self.hauteur = 600
        self.largeur = 800
        self.rHauteur = self.parent.h*self.longeurLigne
        self.rLargeur = self.parent.l*self.longeurLigne
    ...
    def initCadre(self):
        ...
        self.cadreOptionMouton = Frame(self.cadrePartie)
        buttonAttaquer = Button(self.cadreOptionMouton, text="Attaquer", width=8)
        buttonAttaquer.grid(column=0, row=1)
        buttonArreter = Button(self.cadreOptionMouton, text="Arreter", width=8)
        buttonArreter.grid(column=1, row=1)
    ...
    def creerLigne(self):
        ...
        for i in range (self.parent.l):
            for j in range (self.parent.h):
                self.canevasMilieu.create_image(self.canx(i)*self.longeurLigne, self.cany(j)*self.longeurLigne, image=self.imgs["grass"], anchor='nw', tags="grass")
